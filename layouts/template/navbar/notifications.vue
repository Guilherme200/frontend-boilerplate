<template>
  <div>
    ...
    <div
      v-show="dropdown"
      class="notifications z-50 max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg"
    >
...
.notifications {
  ...
  inset: 0 auto auto 0;
  margin: 0;
  transform: translate3d(1291px, 65px, 0px);
}
</style>
