      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center">
          ...
          <div
              ...
              style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(1291.2px, 64.8px, 0px);"
              ...
              <a href="#"
                ...
                <div class="w-full pl-3">
                  <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">New message from <span
                      class="font-semibold text-gray-900 dark:text-white">Bonnie Green</span>: "Hey, what's up? All
                    set
          ...
          <div
              ...
              id="apps-dropdown"
              style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(1331.2px, 64.8px, 0px);"
              data-popper-placement="bottom">
            <div
                class="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              Apps
          ...
          <div id="tooltip-toggle" role="tooltip"
               ...
               style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(1299.2px, 63.2px, 0px);"
               data-popper-placement="bottom">
            Toggle dark mode
          ...
          <div class="flex items-center ml-3">
            ...
            <div
                ...
                id="dropdown-2"
                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(1419.2px, 60.8px, 0px);"
                data-popper-placement="bottom">
